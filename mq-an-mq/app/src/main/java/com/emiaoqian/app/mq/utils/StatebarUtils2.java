...
public class StatebarUtils2 {
   ...
   // public Activity mactivity;
    ...
    public StatebarUtils2(Fragment fragment){
    ...
    public  void setshowstatebar(boolean hidden) {
        String simpleName = fragment.getClass().getSimpleName();
            if (!hidden) {
                LogUtil.e("1024statusbar--"+fragment.getClass().getName());
                ...
                if (Build.VERSION.SDK_INT>=21){
                    ...
                    StatusBarUtil.setColor(fragment.getActivity(), fragment.getActivity().getResources().getColor(R.color.white));
                }
    ...
    public  void fullScreen(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            /****下面是真正能够改变5.0以下状态栏的代码（5.0以下的状态栏有层阴影）****/
            else {
                Window window = activity.getWindow();
    ...
    public int getStatusBarHeight() {
        ...
        if (resourceId > 0) {
            result = fragment.getActivity().getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
